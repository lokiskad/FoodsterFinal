                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild(user_id)){
                            ...
                            if(request_type.equals("recieved")){
                                ...
                                mProfileSendRequestBtn.setText("Akzeptiere Freundesanfrage");
                                ...
                                mProfileSendRequestBtn.setText("Freundesanfrage abbrechen");
                            ...
                            mFriendDatabase.child(mCurrent_user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    if(dataSnapshot.hasChild(user_id)){
                                        ...
                                        mProfileSendRequestBtn.setText("Lösche Freund");
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            mFriendReqDatabase.child(user_id).child(mCurrent_user.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    mProfileSendRequestBtn.setEnabled(true);
                                    mCurrent_state= "not_friends";
                                    mProfileSendRequestBtn.setText("Freundesanfrage");
                    ...
                    mRootRef.updateChildren(unfriendMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError == null){
                                ...
                                mCurrent_state = "not_friends";
                                mProfileSendRequestBtn.setText("Sende Freundesanfrage");
